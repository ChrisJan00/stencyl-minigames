 ...
 * SPRITES
 ***********************************************************************/
function __grannyLeft() { 
__sprite_init__(this, grannyLeft, 16, 16, 0, 0, 'Box', 8, 3, 12, 2, 15, ['img/grannyLeft_0.png']);
}; var grannyLeft = new __grannyLeft();

function __gravePic() { 
__sprite_init__(this, gravePic, 16, 16, 0, 0, 'Box', 8, 3, 12, 7, 16, ['img/gravePic_0.png']);
}; var gravePic = new __gravePic();

function __grannyRight() { 
__sprite_init__(this, grannyRight, 16, 16, 0, 0, 'Box', 8, 4, 13, 2, 16, ['img/grannyRight_0.png']);
}; var grannyRight = new __grannyRight();

function __benchPic() { 
__sprite_init__(this, benchPic, 16, 32, 0, 0, 'Box', 8, 4, 14, 6, 27, ['img/benchPic_0.png']);
}; var benchPic = new __benchPic();

function __benchSitPic() { 
__sprite_init__(this, benchSitPic, 16, 32, 0, 0, 'Box', 8, 4, 14, 6, 27, ['img/benchSitPic_0.png']);
}; var benchSitPic = new __benchSitPic();

function __grannyCuack() { 
__sprite_init__(this, grannyCuack, 16, 16, 0, 0, 'Box', 8, 0, 16, 0, 16, ['img/grannyCuack_0.png']);
}; var grannyCuack = new __grannyCuack();

function __exitArrow() { 
__sprite_init__(this, exitArrow, 16, 16, 0, 0, 'Box', 8, 0, 16, 0, 16, ['img/exitArrow_0.png']);
}; var exitArrow = new __exitArrow();
 ...
 ***********************************************************************/
function __damusic() { 
__audio_init__(this, damusic, '', 'aud/tinyfolk_fast.mp3', 'aud/tinyfolk_fast.ogg');
}; var damusic = new __damusic();

function __gaspSound() { 
__audio_init__(this, gaspSound, '', 'aud/gasp.mp3', 'aud/gasp.ogg');
}; var gaspSound = new __gaspSound();
 ...
 * FONTS
 ***********************************************************************/
function __myfontbig() { 
__font_init__(this, myfontbig, 'Sans', 32, 0, 0)}; var myfontbig = new __myfontbig();

function __myfontsmall() { 
__font_init__(this, myfontsmall, 'Sans', 12, 0, 0)}; var myfontsmall = new __myfontsmall();
 ...
 * OBJECTS
 ***********************************************************************/
function __grannyActor() {
__instance_init__(this, grannyActor, null, 1, 0, grannyRight, 1, 0);
...
with(this) {
this.other = this.place_meeting(this.x, this.y, graveObj);
if(this.other != null) {
x = xprevious;
y = yprevious;
}
this.other = this.place_meeting(this.x, this.y, benchObj);
if(this.other != null) {
if (other.alreadyActivated) {
	x = xprevious;
	y = yprevious;
}
}
...
}; var grannyActor = new __grannyActor();

function __graveObj() {
__instance_init__(this, graveObj, null, 1, 0, gravePic, 1, 2);
...
this.on_animationend = on_animationend_i;
this.on_draw = on_draw_i;
}; var graveObj = new __graveObj();

function __benchObj() {
__instance_init__(this, benchObj, null, 1, 0, benchPic, 1, 59);
this.on_creation = function() {
with(this) {
this.timercount = 0;
this.deathcount = 0;
...
if (this.timercount > 0) {
	...
	if (this.timercount == 0) {
		this.grannyRef.visible = true;
		this.grannyRef.x = 516;
		sprite_index = benchPic;
		exit_mark = instance_create( 3, 200, exitSign );
		
		if (commercialEnabled) {
			if (Math.random() < 0.33) { // 33% chance to die
				sound_play(gaspSound);
				this.grannyRef.moving = false;
				this.grannyRef.sprite_index = grannyCuack;
				this.deathcount = 50;
				isDead = true;
			}
		} else {
...
this.on_collision = function() {
with(this) {
this.other = this.place_meeting(this.x, this.y, grannyActor);
if(this.other != null) {
if (!this.alreadyActivated) {
	...
	this.timercount = 100;
	other.visible = false;
	sprite_index = benchSitPic;
	this.grannyRef = other;
}
}
}
};
...
this.on_animationend = on_animationend_i;
this.on_draw = on_draw_i;
}; var benchObj = new __benchObj();

function __creditsText() {
__instance_init__(this, creditsText, null, 1, 0, null, 1, 61);
this.on_creation = function() {
with(this) {
if (isDead)
	this.counter = 240;
...
if (this.counter > 160 || !isDead) {
	draw_set_font(myfontbig);
	draw_text(200,200,"The end.");
} else {
	draw_set_font(myfontsmall);
	draw_text(120, 120, "based on 'The Graveyard' by Tale Of Tales");
	draw_text(120, 140, "music: 'In the Museum' by Tinyfolk (CC-BY-SA)");
	draw_text(120, 160, "sfx: 'Dying Rasp' by genelythgow (CC-0)");
	draw_text(120, 180, "coding: by Christiaan Janssen (GPLv3)");
	draw_text(120, 200, "soft: Tululoo Game Maker, The Gimp & Audacity");
	draw_text(120, 260, "thank you for playing");
}
}
}
};
}; var creditsText = new __creditsText();

function __beginText() {
__instance_init__(this, beginText, null, 1, 0, null, 1, 63);
this.on_creation = on_creation_i;
this.on_destroy = on_destroy_i;
this.on_step = function() {
with(this) {
...
draw_set_color(255,255,255);
draw_set_font(myfontbig);
draw_text(60,120,"The minimalistic graveyard");
draw_set_font(myfontsmall);
draw_text(120,200,"by Christiaan Janssen");
draw_text(120,220,"Berlin Mini Game Jam January 2013");
draw_text(180,280,"Click here to start");

if (commercialEnabled) {
	draw_text(120,240,"Commercial mode unlocked");
}
}
}
};
}; var beginText = new __beginText();

function __exitSign() {
__instance_init__(this, exitSign, null, 1, 0, exitArrow, 1, 65);
this.on_creation = on_creation_i;
this.on_destroy = on_destroy_i;
this.on_step = on_step_i;
this.on_end_step = on_end_step_i;
 ...
 * SCENES
 ***********************************************************************/
function __startScene() { 
this.tiles = [
];
this.objects = [
[{o:beginText, x:303, y:234}]];
this.start = function() {
__room_start__(this, startScene, 640, 480, 30, 0, 0, 0, null, 0, 0, 0, 640, 480, null, 50, 50);
};
}
var startScene = new __startScene();
tu_scenes.push(startScene);
function __mainScene() { 
this.tiles = [
];
this.objects = [
[{o:grannyActor, x:5, y:208}],
[{o:graveObj, x:288, y:64}],
[{o:graveObj, x:464, y:128}],
[{o:graveObj, x:464, y:256}],
[{o:graveObj, x:368, y:320}],
[{o:graveObj, x:304, y:368}],
[{o:graveObj, x:96, y:400}],
[{o:graveObj, x:224, y:432}],
[{o:graveObj, x:160, y:336}],
[{o:graveObj, x:64, y:112}],
[{o:graveObj, x:192, y:64}],
[{o:graveObj, x:512, y:320}],
[{o:graveObj, x:416, y:416}],
[{o:graveObj, x:560, y:416}],
[{o:graveObj, x:592, y:96}],
[{o:graveObj, x:560, y:176}],
[{o:graveObj, x:432, y:32}],
[{o:graveObj, x:208, y:256}],
[{o:graveObj, x:80, y:40}],
[{o:graveObj, x:240, y:360}],
[{o:graveObj, x:560, y:260}],
[{o:graveObj, x:520, y:400}],
[{o:graveObj, x:340, y:440}],
[{o:graveObj, x:20, y:360}],
[{o:graveObj, x:180, y:400}],
[{o:graveObj, x:280, y:320}],
[{o:graveObj, x:380, y:260}],
[{o:graveObj, x:400, y:120}],
[{o:graveObj, x:180, y:120}],
[{o:graveObj, x:360, y:20}],
[{o:graveObj, x:500, y:60}],
[{o:graveObj, x:540, y:20}],
[{o:graveObj, x:580, y:40}],
[{o:graveObj, x:520, y:100}],
[{o:graveObj, x:360, y:405}],
[{o:graveObj, x:432, y:360}],
[{o:graveObj, x:522, y:441}],
[{o:graveObj, x:594, y:378}],
[{o:graveObj, x:36, y:423}],
[{o:graveObj, x:108, y:360}],
[{o:graveObj, x:36, y:144}],
[{o:graveObj, x:153, y:81}],
[{o:graveObj, x:297, y:117}],
[{o:graveObj, x:351, y:90}],
[{o:graveObj, x:396, y:45}],
[{o:graveObj, x:450, y:81}],
[{o:graveObj, x:504, y:27}],
[{o:graveObj, x:127, y:129}],
[{o:graveObj, x:247, y:89}],
[{o:graveObj, x:552, y:356}],
[{o:graveObj, x:49, y:268}],
[{o:graveObj, x:133, y:282}],
[{o:graveObj, x:238, y:28}],
[{o:graveObj, x:36, y:30}],
[{o:graveObj, x:472, y:416}],
[{o:graveObj, x:128, y:446}],
[{o:graveObj, x:315, y:276}],
[{o:benchObj, x:529, y:193}]];
this.start = function() {
__room_start__(this, mainScene, 640, 480, 30, 0, 0, 0, null, 0, 0, 0, 640, 480, null, 50, 50);
};
}
...
this.objects = [
[{o:creditsText, x:313, y:229}]];
this.start = function() {
__room_start__(this, credits, 640, 480, 30, 0, 0, 0, null, 0, 0, 0, 640, 480, null, 50, 50);
};
}
var credits = new __credits();
tu_scenes.push(credits);
tu_room_to_go = startScene;
