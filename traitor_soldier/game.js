 ...
 * SPRITES
 ***********************************************************************/
function __soldier_look_rt() { 
__sprite_init__(this, soldier_look_rt, 10, 26, 5, 13, 'Box', 5, 0, 10, 0, 26, ['img/soldier_look_rt_0.png']);
}; var soldier_look_rt = new __soldier_look_rt();

function __soldier_look_lt() { 
__sprite_init__(this, soldier_look_lt, 10, 26, 5, 13, 'Box', 5, 0, 10, 0, 26, ['img/soldier_look_lt_0.png']);
}; var soldier_look_lt = new __soldier_look_lt();

function __soldier_walk_lt() { 
__sprite_init__(this, soldier_walk_lt, 10, 26, 5, 13, 'Box', 5, 0, 10, 0, 26, ['img/soldier_walk_lt_0.png','img/soldier_walk_lt_1.png']);
}; var soldier_walk_lt = new __soldier_walk_lt();

function __soldier_walk_rt() { 
__sprite_init__(this, soldier_walk_rt, 10, 26, 5, 13, 'Box', 5, 0, 10, 0, 26, ['img/soldier_walk_rt_0.png','img/soldier_walk_rt_1.png']);
}; var soldier_walk_rt = new __soldier_walk_rt();

function __bullet_img() { 
__sprite_init__(this, bullet_img, 4, 4, 2, 2, 'Box', 2, 0, 4, 0, 4, ['img/bullet_img_0.png']);
}; var bullet_img = new __bullet_img();

function __splash() { 
__sprite_init__(this, splash, 20, 20, 10, 10, 'Box', 10, 0, 20, 0, 20, ['img/splash_0.png']);
}; var splash = new __splash();

function __grave() { 
__sprite_init__(this, grave, 20, 20, 10, 10, 'Box', 10, 4, 14, 2, 20, ['img/grave_0.png']);
}; var grave = new __grave();

function __enemy_look_left() { 
__sprite_init__(this, enemy_look_left, 10, 26, 5, 13, 'Box', 5, 0, 10, 0, 26, ['img/enemy_look_left_0.png']);
}; var enemy_look_left = new __enemy_look_left();

function __enemy_look_right() { 
__sprite_init__(this, enemy_look_right, 10, 26, 5, 13, 'Box', 5, 0, 10, 0, 26, ['img/enemy_look_right_0.png']);
}; var enemy_look_right = new __enemy_look_right();

function __enemy_walk_left() { 
__sprite_init__(this, enemy_walk_left, 10, 26, 5, 13, 'Box', 5, 0, 10, 0, 26, ['img/enemy_walk_left_0.png','img/enemy_walk_left_1.png']);
}; var enemy_walk_left = new __enemy_walk_left();

function __enemy_walk_right() { 
__sprite_init__(this, enemy_walk_right, 10, 26, 5, 13, 'Box', 5, 0, 10, 0, 26, ['img/enemy_walk_right_0.png','img/enemy_walk_right_1.png']);
}; var enemy_walk_right = new __enemy_walk_right();

function __wall_img() { 
__sprite_init__(this, wall_img, 20, 20, 0, 0, 'Box', 10, 0, 20, 0, 20, ['img/wall_img_0.png']);
}; var wall_img = new __wall_img();

function __select_box() { 
__sprite_init__(this, select_box, 20, 40, 10, 20, 'Box', 10, 0, 20, 0, 40, ['img/select_box_0.png']);
}; var select_box = new __select_box();
 ...
 ***********************************************************************/
function __soldier() {
__instance_init__(this, soldier, null, 1, 0, soldier_look_rt, 1, 0);
...
this.shootTimer = Math.floor(Math.random() * shootDelay)

if (soldierList.length == 0)
	this.active = true
soldierList.push(this)
}
};
...
if (this.moving) {
	if ( keyboard_check( vk_right ) ) this.shootDir[0] = 1;
	else if (keyboard_check( vk_left ) ) this.shootDir[0] = -1;
	else this.shootDir[0] = 0;
	
	if ( keyboard_check( vk_up ) ) this.shootDir[1] = -1;
	else if ( keyboard_check( vk_down ) ) this.shootDir[1] = 1;
	else this.shootDir[1] = 0;
	
	if ((this.shootDir[0] == 0) && (this.shootDir[1] == 0)) this.shootDir = [1,0];
}

// shoot
if (this.active && this.bulletCharge <= 0) {
	if ( keyboard_check( vk_x ) ) {
		this.bulletCharge = 10;
		instance_create( x + this.shootDir[0] * 15, y + this.shootDir[1] * 15, bullet_obj, this.shootDir)
	}
}

if (this.active) {
	if (keyboard_check_pressed( vk_c ) && !blockKeyC) {
		blockKeyC = true;
		soldierIndex++;
		if (soldierIndex >= soldierList.length)
			soldierIndex = 0;
		this.active = false;
		soldierList[soldierIndex].active = true
	}
}

if (keyboard_check_released( vk_c ))
	blockKeyC = false

// sprite
if (this.lookRight) {
	if (this.moving)
		sprite_index = soldier_walk_rt;
	else
		sprite_index = soldier_look_rt;
} else {
	if (this.moving)
		sprite_index = soldier_walk_lt;
	else
		sprite_index = soldier_look_lt;

}
if (this.bulletCharge > 0)
	this.bulletCharge = this.bulletCharge - 1
	
	// shoot to the closest soldier
if (!this.active) {
	if (this.shootTimer > 0)
		this.shootTimer = this.shootTimer - 1;
	else {
		this.shootTimer = shootDelay
		shootSoldier(this.x, this.y)
	}
}
if (mouse_check_pressed()) {
	if (mouse_x >= x - 10 && mouse_x <= x + 10 &&
		mouse_y >= y - 10 && mouse_y <= y + 10) {
		for (var i = 0; i < soldierList.length; i++)
			if (soldierList[i] == this) {
				soldierList[soldierIndex].active = false;
				soldierIndex = i;
				this.active = true;
			}
		}
...
with(this) {
this.other = this.place_meeting(this.x, this.y, bullet_obj);
if(this.other != null) {
instance_create(x,y,splash_obj)
instance_destroy()
other.instance_destroy()

var thisIndex = soldierList.indexOf(this);
soldierList[soldierIndex].active = false;
if (soldierIndex > thisIndex)
	soldierIndex = soldierIndex - 1;
if (soldierIndex >= soldierList.length-1)
	soldierIndex = 0;

soldierList.splice(soldierList.indexOf(this),1)

if (soldierIndex < soldierList.length)
	soldierList[soldierIndex].active = true;
}
this.other = this.place_meeting(this.x, this.y, grave_obj);
if(this.other != null) {
x = xprevious
y = yprevious
}
this.other = this.place_meeting(this.x, this.y, wall_obj);
if(this.other != null) {
x = xprevious
y = yprevious
}
...
__handle_sprite__(this);
with(this) {
if (soldierList[soldierIndex] == this) {
	draw_sprite_ext(select_box, 0, this.x, this.y, this.image_xscale, this.image_yscale, this.image_angle, this.image_alpha);
}
draw_sprite_ext(this.sprite_index, this.image_index, this.x, this.y, this.image_xscale, this.image_yscale, this.image_angle, this.image_alpha);
...
}; var soldier = new __soldier();

function __bullet_obj() {
__instance_init__(this, bullet_obj, null, 1, 0, bullet_img, 1, 1);
this.on_creation = function() {
with(this) {
this.moveSpeed = 10;
this.xinc = parameters[0][0] * this.moveSpeed;
this.yinc = parameters[0][1] * this.moveSpeed;
}
};
this.on_destroy = on_destroy_i;
this.on_step = function() {
...
if (x > room_width || x < 0 || y > room_width || y < 0)
	instance_destroy();
}
};
this.on_end_step = on_end_step_i;
...
}; var bullet_obj = new __bullet_obj();

function __enemy() {
__instance_init__(this, enemy, null, 1, 0, enemy_look_left, 1, 2);
this.on_creation = function() {
with(this) {
this.shootTimer = Math.floor(Math.random() * shootDelay)
this.moveDelay = 60
...
function __splash_obj() {
__instance_init__(this, splash_obj, null, 1, 0, splash, 1, 4);
this.on_creation = function() {
with(this) {
this.graveTimer = 50
}
...
this.on_step = function() {
with(this) {
this.graveTimer = this.graveTimer - 1
if (this.graveTimer <= 0) {
	instance_create(x,y,grave_obj)
	instance_destroy()
}
}
};
...
this.on_animationend = on_animationend_i;
this.on_draw = on_draw_i;
}; var splash_obj = new __splash_obj();

function __grave_obj() {
__instance_init__(this, grave_obj, null, 1, 0, grave, 1, 5);
this.on_creation = function() {
with(this) {
if (enemy_count == 0) {
	room_goto(win);
...
this.on_animationend = on_animationend_i;
this.on_draw = on_draw_i;
}; var grave_obj = new __grave_obj();

function __wall_obj() {
__instance_init__(this, wall_obj, null, 1, 0, wall_img, 1, 6);
this.on_creation = function() {
with(this) {
...
this.on_animationend = on_animationend_i;
this.on_draw = on_draw_i;
}; var wall_obj = new __wall_obj();

function __gameovertext() {
__instance_init__(this, gameovertext, null, 1, 0, null, 1, 250);
...
}; var gameovertext = new __gameovertext();

function __wintext() {
__instance_init__(this, wintext, null, 1, 0, null, 1, 251);
this.on_creation = on_creation_i;
this.on_destroy = on_destroy_i;
this.on_step = on_step_i;
this.on_end_step = on_end_step_i;
...
draw_set_color(255,255,255);
draw_set_font("32px");
draw_text(100,200,"SUCCESS")
}
}
};
}; var wintext = new __wintext();
...
this.objects = [
[{o:enemy, x:525, y:96}],
[{o:wall_obj, x:340, y:160}],
[{o:wall_obj, x:320, y:160}],
[{o:wall_obj, x:300, y:160}],
[{o:wall_obj, x:280, y:160}],
[{o:wall_obj, x:280, y:140}],
[{o:wall_obj, x:300, y:140}],
[{o:wall_obj, x:280, y:120}],
[{o:soldier, x:220, y:400}],
[{o:wall_obj, x:340, y:300}],
[{o:wall_obj, x:320, y:300}],
[{o:wall_obj, x:300, y:300}],
[{o:wall_obj, x:280, y:300}],
[{o:wall_obj, x:260, y:280}],
[{o:wall_obj, x:260, y:260}],
[{o:wall_obj, x:220, y:360}],
[{o:wall_obj, x:200, y:360}],
[{o:wall_obj, x:400, y:200}],
[{o:wall_obj, x:400, y:220}],
[{o:wall_obj, x:400, y:240}],
[{o:wall_obj, x:400, y:260}],
[{o:wall_obj, x:400, y:300}],
[{o:wall_obj, x:400, y:280}],
[{o:wall_obj, x:440, y:80}],
[{o:wall_obj, x:440, y:100}],
[{o:wall_obj, x:440, y:100}],
[{o:wall_obj, x:440, y:120}],
[{o:wall_obj, x:460, y:120}],
[{o:wall_obj, x:480, y:120}],
[{o:wall_obj, x:500, y:120}],
[{o:wall_obj, x:500, y:40}],
[{o:wall_obj, x:540, y:40}],
[{o:wall_obj, x:520, y:40}],
[{o:wall_obj, x:560, y:40}],
[{o:wall_obj, x:560, y:80}],
[{o:wall_obj, x:560, y:60}],
[{o:wall_obj, x:560, y:100}],
[{o:wall_obj, x:560, y:140}],
[{o:wall_obj, x:560, y:120}],
[{o:wall_obj, x:560, y:160}],
[{o:wall_obj, x:500, y:140}],
[{o:wall_obj, x:500, y:160}],
[{o:wall_obj, x:500, y:180}],
[{o:wall_obj, x:580, y:160}],
[{o:wall_obj, x:600, y:160}],
[{o:wall_obj, x:620, y:160}],
[{o:wall_obj, x:500, y:200}],
[{o:wall_obj, x:500, y:240}],
[{o:wall_obj, x:500, y:220}],
[{o:wall_obj, x:500, y:300}],
[{o:wall_obj, x:520, y:300}],
[{o:wall_obj, x:560, y:300}],
[{o:wall_obj, x:540, y:300}],
[{o:wall_obj, x:580, y:300}],
[{o:wall_obj, x:600, y:300}],
[{o:wall_obj, x:620, y:300}],
[{o:wall_obj, x:620, y:280}],
[{o:wall_obj, x:620, y:220}],
[{o:wall_obj, x:620, y:200}],
[{o:wall_obj, x:620, y:180}],
[{o:wall_obj, x:60, y:60}],
[{o:wall_obj, x:60, y:80}],
[{o:wall_obj, x:60, y:100}],
[{o:wall_obj, x:60, y:120}],
[{o:wall_obj, x:80, y:120}],
[{o:wall_obj, x:100, y:120}],
[{o:wall_obj, x:120, y:120}],
[{o:wall_obj, x:120, y:80}],
[{o:wall_obj, x:120, y:60}],
[{o:wall_obj, x:120, y:100}],
[{o:wall_obj, x:180, y:180}],
[{o:wall_obj, x:160, y:180}],
[{o:wall_obj, x:140, y:180}],
[{o:wall_obj, x:120, y:180}],
[{o:wall_obj, x:100, y:180}],
[{o:wall_obj, x:80, y:180}],
[{o:wall_obj, x:60, y:180}],
[{o:wall_obj, x:120, y:200}],
[{o:wall_obj, x:120, y:220}],
[{o:wall_obj, x:120, y:240}],
[{o:wall_obj, x:120, y:260}],
[{o:wall_obj, x:120, y:280}],
[{o:wall_obj, x:160, y:520}],
[{o:wall_obj, x:160, y:500}],
[{o:wall_obj, x:160, y:480}],
[{o:wall_obj, x:140, y:480}],
[{o:wall_obj, x:120, y:480}],
[{o:wall_obj, x:100, y:480}],
[{o:wall_obj, x:80, y:480}],
[{o:wall_obj, x:80, y:420}],
[{o:wall_obj, x:80, y:400}],
[{o:wall_obj, x:80, y:380}],
[{o:wall_obj, x:80, y:360}],
[{o:wall_obj, x:20, y:300}],
[{o:wall_obj, x:0, y:300}],
[{o:wall_obj, x:60, y:300}],
[{o:wall_obj, x:40, y:300}],
[{o:wall_obj, x:340, y:400}],
[{o:wall_obj, x:340, y:420}],
[{o:wall_obj, x:340, y:440}],
[{o:wall_obj, x:340, y:460}],
[{o:wall_obj, x:340, y:480}],
[{o:wall_obj, x:340, y:500}],
[{o:wall_obj, x:340, y:520}],
[{o:wall_obj, x:320, y:440}],
[{o:wall_obj, x:300, y:440}],
[{o:wall_obj, x:280, y:440}],
[{o:wall_obj, x:260, y:440}],
[{o:wall_obj, x:260, y:460}],
[{o:wall_obj, x:260, y:480}],
[{o:wall_obj, x:400, y:340}],
[{o:wall_obj, x:400, y:320}],
[{o:wall_obj, x:400, y:360}],
[{o:wall_obj, x:400, y:380}],
[{o:wall_obj, x:400, y:400}],
[{o:wall_obj, x:500, y:420}],
[{o:wall_obj, x:500, y:440}],
[{o:wall_obj, x:500, y:460}],
[{o:wall_obj, x:520, y:460}],
[{o:wall_obj, x:540, y:460}],
[{o:wall_obj, x:560, y:460}],
[{o:wall_obj, x:580, y:460}],
[{o:wall_obj, x:580, y:420}],
[{o:wall_obj, x:580, y:440}],
[{o:wall_obj, x:500, y:400}],
[{o:wall_obj, x:500, y:380}],
[{o:wall_obj, x:500, y:360}],
[{o:wall_obj, x:520, y:360}],
[{o:wall_obj, x:540, y:360}],
[{o:wall_obj, x:560, y:360}],
[{o:wall_obj, x:580, y:360}],
[{o:wall_obj, x:580, y:380}],
[{o:wall_obj, x:580, y:400}],
[{o:wall_obj, x:540, y:400}],
[{o:wall_obj, x:540, y:420}],
[{o:wall_obj, x:680, y:460}],
[{o:wall_obj, x:660, y:460}],
[{o:wall_obj, x:640, y:460}],
[{o:wall_obj, x:140, y:100}],
[{o:wall_obj, x:140, y:80}],
[{o:wall_obj, x:160, y:80}],
[{o:wall_obj, x:140, y:60}],
[{o:wall_obj, x:160, y:60}],
[{o:wall_obj, x:180, y:60}],
[{o:wall_obj, x:200, y:60}],
[{o:enemy, x:100, y:80}],
[{o:enemy, x:60, y:260}],
[{o:enemy, x:80, y:460}],
[{o:enemy, x:540, y:220}],
[{o:enemy, x:600, y:80}],
[{o:enemy, x:160, y:20}],
[{o:soldier, x:100, y:160}],
[{o:soldier, x:680, y:520}],
[{o:soldier, x:480, y:400}],
[{o:soldier, x:660, y:200}],
[{o:soldier, x:140, y:520}],
[{o:enemy, x:320, y:480}],
[{o:enemy, x:300, y:280}],
[{o:enemy, x:220, y:340}],
[{o:wall_obj, x:700, y:460}],
[{o:wall_obj, x:700, y:480}],
[{o:wall_obj, x:700, y:500}],
[{o:wall_obj, x:700, y:520}],
[{o:wall_obj, x:700, y:540}],
[{o:wall_obj, x:680, y:540}],
[{o:wall_obj, x:660, y:540}],
[{o:wall_obj, x:640, y:540}],
[{o:wall_obj, x:640, y:160}],
[{o:wall_obj, x:660, y:160}],
[{o:wall_obj, x:660, y:0}],
[{o:wall_obj, x:660, y:20}],
[{o:wall_obj, x:660, y:40}],
[{o:wall_obj, x:660, y:80}],
[{o:wall_obj, x:660, y:60}],
[{o:wall_obj, x:660, y:140}],
[{o:wall_obj, x:720, y:280}],
[{o:wall_obj, x:740, y:280}],
[{o:wall_obj, x:760, y:300}],
[{o:wall_obj, x:760, y:280}],
[{o:wall_obj, x:780, y:280}],
[{o:wall_obj, x:780, y:300}],
[{o:wall_obj, x:780, y:320}],
[{o:wall_obj, x:780, y:340}],
[{o:wall_obj, x:760, y:320}],
[{o:wall_obj, x:740, y:300}],
[{o:wall_obj, x:720, y:300}],
[{o:wall_obj, x:740, y:320}],
[{o:wall_obj, x:740, y:340}],
[{o:wall_obj, x:760, y:340}],
[{o:wall_obj, x:760, y:360}],
[{o:wall_obj, x:760, y:380}],
[{o:wall_obj, x:760, y:380}],
[{o:wall_obj, x:780, y:380}],
[{o:wall_obj, x:780, y:400}],
[{o:wall_obj, x:780, y:420}],
[{o:wall_obj, x:780, y:360}],
[{o:wall_obj, x:340, y:540}],
[{o:wall_obj, x:340, y:560}],
[{o:wall_obj, x:340, y:580}],
[{o:wall_obj, x:260, y:500}],
[{o:wall_obj, x:260, y:520}],
[{o:wall_obj, x:160, y:540}],
[{o:wall_obj, x:160, y:560}],
[{o:wall_obj, x:160, y:580}],
[{o:wall_obj, x:60, y:480}],
[{o:wall_obj, x:60, y:500}],
[{o:wall_obj, x:400, y:520}],
[{o:wall_obj, x:420, y:520}],
[{o:wall_obj, x:480, y:520}],
[{o:wall_obj, x:500, y:520}],
[{o:wall_obj, x:520, y:520}],
[{o:wall_obj, x:540, y:520}],
[{o:wall_obj, x:560, y:520}],
[{o:wall_obj, x:580, y:520}],
[{o:wall_obj, x:580, y:560}],
[{o:wall_obj, x:580, y:580}],
[{o:wall_obj, x:580, y:540}],
[{o:enemy, x:560, y:560}],
[{o:enemy, x:740, y:520}],
[{o:enemy, x:700, y:20}],
[{o:wall_obj, x:60, y:520}],
[{o:wall_obj, x:60, y:540}],
[{o:wall_obj, x:60, y:420}],
[{o:wall_obj, x:40, y:420}],
[{o:wall_obj, x:120, y:420}],
[{o:wall_obj, x:100, y:420}],
[{o:wall_obj, x:180, y:360}],
[{o:wall_obj, x:160, y:360}],
[{o:wall_obj, x:240, y:360}],
[{o:wall_obj, x:260, y:360}],
[{o:wall_obj, x:40, y:180}],
[{o:wall_obj, x:120, y:40}],
[{o:wall_obj, x:120, y:20}],
[{o:wall_obj, x:120, y:0}],
[{o:wall_obj, x:520, y:160}],
[{o:wall_obj, x:540, y:160}],
[{o:wall_obj, x:680, y:80}],
[{o:wall_obj, x:700, y:80}],
[{o:wall_obj, x:720, y:80}],
[{o:wall_obj, x:660, y:220}],
[{o:wall_obj, x:640, y:220}],
[{o:wall_obj, x:480, y:460}],
[{o:wall_obj, x:460, y:460}],
[{o:wall_obj, x:440, y:460}]];
this.start = function() {
__room_start__(this, scene_10, 800, 600, 30, 0, 47, 28, null, 0, 0, 0, 800, 600, null, 50, 50);
};
}
var scene_10 = new __scene_10();
tu_scenes.push(scene_10);
function __gameover() { 
this.tiles = [
];
this.objects = [
[{o:gameovertext, x:300, y:220}]];
this.start = function() {
__room_start__(this, gameover, 640, 480, 30, 0, 0, 0, null, 0, 0, 0, 640, 480, null, 50, 50);

draw_set_color(255, 255, 255)
draw_set_font("Helvetica sans 36px")
draw_text(100,200,"GAME OVER")
};
}
var gameover = new __gameover();
tu_scenes.push(gameover);
function __win() { 
this.tiles = [
];
this.objects = [
[{o:wintext, x:300, y:200}]];
this.start = function() {
__room_start__(this, win, 640, 480, 30, 0, 0, 0, null, 0, 0, 0, 640, 480, null, 50, 50);

draw_set_font("Helvetica sans 36px")
draw_text(100,200,"SUCESS")
};
}
var win = new __win();
tu_scenes.push(win);
tu_room_to_go = scene_10;
...
function distanceSqTo(fromx, fromy, tox, toy) 
{
	var dx = tox - fromx
	var dy = toy - fromy
	return dx*dx + dy * dy
...
function shootSoldier(fromx, fromy) {
	var mindst = 800*800 * 2
	var selection = 0;
	for (var i=0; i<soldierList.length; i++) {
		var dst = distanceSqTo(fromx, fromy, soldierList[i].x, soldierList[i].y);
		if (dst > 0 && dst < mindst) {
			selection = i;
			mindst = dst;
		}
	...
	// avoid out of bounds
	if (selection >= soldierList.length)
		return;
	
	var dx = (soldierList[selection].x - fromx)/Math.sqrt(mindst);
	var dy = (soldierList[selection].y - fromy)/Math.sqrt(mindst);
	var incx = -10
	if (dx >= 0)
		incx = 10
	var incy = -20
	if (dy >= 0)
		incy = 20
	instance_create(fromx + incx, fromy + incy, bullet_obj, [dx,dy]);
